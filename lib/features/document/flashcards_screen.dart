...
class _Flashcard {
  const _Flashcard({required this.question, required this.answer, required this.explanation});
  final String question;
  final String answer;
  final String explanation;
}

// TODO: replace with Firestore-backed flashcards for this document
const _cards = [
  _Flashcard(
    question: 'What is the primary sign of hypovolemia?',
    answer: 'Tachycardia & Hypotension',
    explanation:
        'A rapid pulse is typically the earliest sign as the heart compensates for low fluid volume.',
  ),
  _Flashcard(
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    Text('Anatomy & Physiology', style: AppTextStyles.bodySm()),
                  ],
                ),
                ...
                Row(
                  ...
                  children: [
                    ...
                    _NavButton(
                        icon: Symbols.chevron_right, label: 'Next', onTap: () => _next()),
                  ],
                ),
              ],
            ),
